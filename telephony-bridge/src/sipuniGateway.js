...
function normalizeGatewayPayload(input = {}) {
  ...
  return {
    ...
    runtimeNumberRef: firstNonEmpty(
      input.runtimeNumberRef,
      input.runtime_number_ref,
      input.outboundRuntimeNumberRef,
      input.outbound_runtime_number_ref,
...
function publicGatewayEntry(gateway) {
  return compactObject({
    ...
    runtimeNumberRef: gateway.runtimeNumberRef,
    outboundRuntimeNumberRef: gateway.runtimeNumberRef,
